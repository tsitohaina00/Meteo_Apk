...
class TemperatureInfo {
 ...
 final int humidity;
  ...
  TemperatureInfo({required this.temperature,required this.pressure,required this.humidity});

  factory TemperatureInfo.fromJson(Map<String, dynamic> json) {
    final temperature = json['temp'];
    final pressure = json['pressure'];
    final humidity = json['humidity'];
    return TemperatureInfo(temperature: temperature,pressure: pressure,humidity: humidity);
  }
}
